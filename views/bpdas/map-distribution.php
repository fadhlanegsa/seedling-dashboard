<?php
/**
 * Map Distribution View - BPDAS
 * Visualisasi peta distribusi bibit untuk BPDAS
 */
?>

<div class="page-header">
    <h1><i class="fas fa-map-marked-alt"></i> Peta Distribusi Bibit</h1>
    <p>Visualisasi sebaran lokasi penanaman bibit dari <?= htmlspecialchars($bpdas_name) ?></p>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadMapData() {
        ...
        fetch('<?= url('bpdas/get-map-data') ?>?' + queryString)
                    ...
                    data.data.forEach(item => {
                        ...
                        const popupContent = `
                            <div style="min-width: 200px;">
                                ...
                                <p style="margin: 5px 0;">
                                    <i class="fas fa-calendar"></i> <strong>Tanggal Permintaan:</strong><br>
                                    ${new Date(item.created_at).toLocaleDateString('id-ID')}
                                </p>
                                ${item.approval_date ? `
                                <p style="margin: 5px 0;">
                                    <i class="fas fa-calendar-check"></i> <strong>Tanggal Disetujui:</strong><br>
                                    ${new Date(item.approval_date).toLocaleDateString('id-ID')}
                                </p>
                                ` : ''}
                                <p style="margin: 5px 0;">
