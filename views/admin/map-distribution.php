...
<div class="page-header">
    ...
    <p>Visualisasi sebaran lokasi penanaman bibit di seluruh Indonesia</p>
</div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select id="filterProvince" class="form-control">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label>BPDAS</label>
                    <select id="filterBPDAS" class="form-control">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadMapData() {
        ...
        fetch('<?= url('admin/get-map-data') ?>?' + queryString)
