...
define('RECAPTCHA_SITE_KEY', '6LeCkTEtAAAAAHuXFGiekgQVy91dgNGrbnpsD1Az');
define('RECAPTCHA_SECRET_KEY', '6LeCkTEtAAAAAA8A2WrhxsYWEQAWydQS1t4tb3vm');
define('DISABLE_RECAPTCHA', false); // SET TO true UNTUK BYPASS SEMENTARA KARENA SITE KEY DI CONSOLE GOOGLE BERMASALAH (401).
